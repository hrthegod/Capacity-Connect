...
export default function AdminDashboard({ onNavigate }) {
  ...
  const [newCourseCategory, setNewCourseCategory] =
  ...
  const handleQuickAddSubmit = async (e) => {
    ...
    try {
      ...
      setFormSuccessMessage(
        `Success! New ${modalType} synced with backend database.`
      );

      // Refresh dashboard numbers after adding a record
      if (modalType === "user") {
        analyticsService
          .getDashboardStats()
      ...
      console.error(
        "Error submitting quick add to database:",
        err
      );

      setFormSuccessMessage(
        "Unable to save record. Please check the backend."
      );
    }
  };
  ...
  const getCoordinates = (index, val) => {
    const x =
      paddingX +
      (index / (MONTHLY_USER_GROWTH.length - 1)) *
  ...
  const points = MONTHLY_USER_GROWTH.map((d, i) =>
    getCoordinates(i, d.users)
  );

  const activePoints = MONTHLY_USER_GROWTH.map((d, i) =>
    getCoordinates(i, d.active)
  );

  const svgLinePath = points.reduce(
    (acc, pt, i) =>
      `${acc} ${i === 0 ? "M" : "L"} ${pt.x},${pt.y}`,
    ""
  );

  const svgActiveLinePath = activePoints.reduce(
    (acc, pt, i) =>
      `${acc} ${i === 0 ? "M" : "L"} ${pt.x},${pt.y}`,
    ""
  );

  const svgAreaPath = `${svgLinePath} L ${
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-header-banner">
        <div className="dashboard-title-group">
          ...
          <p className="dashboard-subtitle">
            ...
            All systems operational for Smart India Hackathon.
          </p>
        </div>
      ...
      <div className="stats-grid-6">
        ...
        <StatCard
          title="Trainers"
          value={stats ? stats.totalTrainers : 0}
          change="+8.4%"
          isPositive={true}
          icon={FiUserCheck}
          colorScheme="purple"
        ...
        <StatCard
          title="Learners"
          value={stats ? stats.totalLearners : 0}
          change="+13.2%"
          isPositive={true}
          icon={FiBookOpen}
          colorScheme="cyan"
        ...
        <div className="dashboard-card">
          ...
          <div className="dashboard-card-header">
            ...
            <div className="card-title">
              <FiTrendingUp style={{ color: "#0788C9" }} />
              User Growth
            </div>
      ...
      <div className="dashboard-secondary-row">
          ...
          <div className="activity-feed-list">
            ...
            <div className="activity-feed-item">
              ...
              <div className="feed-details">
                ...
                <div className="feed-text">
                  Dr. Rajesh Sharma approved new GeM Procurement syllabus
                </div>
            ...
            <div className="activity-feed-item">
              ...
              <div className="feed-details">
                ...
                <div className="feed-text">
                  45 Municipal engineers enrolled in "Digital District Governance"
                </div>
            ...
            <div className="activity-feed-item">
              ...
              <div className="feed-details">
                ...
                <div className="feed-text">
                  Learner Pooja Sundaram achieved "Expert" badge in Cloud Security
                </div>
            ...
            <div className="activity-feed-item">
              ...
              <div className="feed-details">
                ...
                <div className="feed-text">
                  Disaster Evacuation SOP submitted for Knowledge Hub verification
                </div>
        ...
        >
          ...
          >
            Capacity Connect operates as the unified civil-capability
            acceleration pipeline. All modules—from Trainer credentials
            to Competency taxonomies—are synchronized with national
            training frameworks.
          </p>
          ...
          >
            ...
            >
              <div>
                • 5 new curriculum syllabi awaiting accreditation
              </div>

              <div>
                • 1 organization onboarding request in review
              </div>

              <div>
                • Monthly competency audit report scheduled for 18:00
              </div>
            </div>
          ...
          >
            Open Approval Center ({pendingApprovals})
          </button>
